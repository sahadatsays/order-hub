...
<div class="fixed inset-0 flex flex-col bg-slate-100" style="top: 0; z-index: 40;">
    ...
    <div class="flex flex-1 min-h-0 gap-0">
        ...
        {{-- RIGHT PANEL: Cart --}}
        <div class="w-100 flex flex-col bg-white border-l border-slate-200 shrink-0">
            ...
            <div class="border-t border-slate-100 px-5 py-4 space-y-4">
                ...
                <div id="cash-tender-section">
                    ...
                    <div id="change-display" class="hidden mt-2 items-center justify-between bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-2.5">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ── Customer selection via CustomerSearch component events ──
    document.addEventListener('customer-selected', function(e) {
        selectedCustomer = e.detail.customer;
    });
    ...
    function updateChange() {
        ...
        if (paymentMethod === 'cash' && tendered > 0 && tendered >= total) {
            ...
            changeDisplayEl.classList.add('flex');
        } else {
            changeDisplayEl.classList.add('hidden');
            changeDisplayEl.classList.remove('flex');
        }
    }
    ...
    function submitOrder(isPaid) {
        ...
        .then(data => {
            ...
            cart = [];
            selectedCustomer = null;
            // Reset the customer search component
            document.querySelectorAll('[data-customer-search]').forEach(el => {
                if (el._csInit) { el._csInit.clear(); }
            });
