<x-layouts.app title="Dashboard">
    ...
    >
        <x-slot:actions>
            <div class="flex items-center gap-2 bg-white border border-zinc-200 rounded-md px-3 py-2 text-sm text-zinc-600 cursor-pointer hover:bg-zinc-50 transition-colors">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-4">
        ...
        <div class="bg-white border border-zinc-200 rounded-xl overflow-hidden">
            <div class="flex items-center justify-between px-6 py-4 border-b border-zinc-100">
                ...
                <a href="#" class="text-xs font-medium text-indigo-600 hover:text-indigo-700 transition-colors flex items-center gap-1">
                    View all
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-zinc-50">
                        <tr class="hover:bg-zinc-50 transition-colors">
                            <td class="px-5 py-3.5 font-mono text-xs text-zinc-600">ORD-0284</td>
                            <td class="px-4 py-3.5 text-sm font-medium text-zinc-800">Acme Ltd</td>
                            <td class="px-4 py-3.5 text-sm text-zinc-700 tabular-nums">$1,240</td>
                            <td class="px-4 py-3.5"><x-ui.badge color="green">Delivered</x-ui.badge></td>
                            <td class="px-5 py-3.5 text-xs text-zinc-400">Mar 14</td>
                        </tr>
                        <tr class="hover:bg-zinc-50 transition-colors">
                            <td class="px-5 py-3.5 font-mono text-xs text-zinc-600">ORD-0283</td>
                            <td class="px-4 py-3.5 text-sm font-medium text-zinc-800">Beta Corp</td>
                            <td class="px-4 py-3.5 text-sm text-zinc-700 tabular-nums">$880</td>
                            <td class="px-4 py-3.5"><x-ui.badge color="blue">Processing</x-ui.badge></td>
                            <td class="px-5 py-3.5 text-xs text-zinc-400">Mar 14</td>
                        </tr>
                        <tr class="hover:bg-zinc-50 transition-colors">
                            <td class="px-5 py-3.5 font-mono text-xs text-zinc-600">ORD-0282</td>
                            <td class="px-4 py-3.5 text-sm font-medium text-zinc-800">Gamma Inc</td>
                            <td class="px-4 py-3.5 text-sm text-zinc-700 tabular-nums">$2,100</td>
                            <td class="px-4 py-3.5"><x-ui.badge color="yellow">Pending</x-ui.badge></td>
                            <td class="px-5 py-3.5 text-xs text-zinc-400">Mar 13</td>
                        </tr>
                        <tr class="hover:bg-zinc-50 transition-colors">
                            <td class="px-5 py-3.5 font-mono text-xs text-zinc-600">ORD-0281</td>
                            <td class="px-4 py-3.5 text-sm font-medium text-zinc-800">Delta LLC</td>
                            <td class="px-4 py-3.5 text-sm text-zinc-700 tabular-nums">$430</td>
                            <td class="px-4 py-3.5"><x-ui.badge color="green">Delivered</x-ui.badge></td>
                            <td class="px-5 py-3.5 text-xs text-zinc-400">Mar 13</td>
                        </tr>
                        <tr class="hover:bg-zinc-50 transition-colors">
                            <td class="px-5 py-3.5 font-mono text-xs text-zinc-600">ORD-0280</td>
                            <td class="px-4 py-3.5 text-sm font-medium text-zinc-800">Echo Co</td>
                            <td class="px-4 py-3.5 text-sm text-zinc-700 tabular-nums">$3,200</td>
                            <td class="px-4 py-3.5"><x-ui.badge color="red">Cancelled</x-ui.badge></td>
                            <td class="px-5 py-3.5 text-xs text-zinc-400">Mar 12</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="bg-white border border-zinc-200 rounded-xl p-6">
            <div class="mb-5">
                <h3 class="text-sm font-semibold text-zinc-900">Top Products</h3>
                <p class="text-xs text-zinc-500 mt-0.5">by revenue this month</p>
            </div>
            <div class="space-y-5">

                <div>
                    <div class="flex items-center gap-3 mb-1.5">
                        <span class="text-xs font-semibold text-zinc-400 w-4 shrink-0 tabular-nums">1</span>
                        <span class="text-sm font-medium text-zinc-900 flex-1 truncate">Cloud Storage Pro</span>
                        <span class="text-sm text-zinc-600 tabular-nums shrink-0">$14,200</span>
                    </div>
                    <div class="ml-7 relative w-full bg-zinc-100 h-1.5 rounded-full overflow-hidden">
                        <div class="absolute inset-y-0 left-0 bg-indigo-500 rounded-full" style="width: 95%"></div>
                    </div>
                </div>

                <div>
                    <div class="flex items-center gap-3 mb-1.5">
                        <span class="text-xs font-semibold text-zinc-400 w-4 shrink-0 tabular-nums">2</span>
                        <span class="text-sm font-medium text-zinc-900 flex-1 truncate">Team Collaboration</span>
                        <span class="text-sm text-zinc-600 tabular-nums shrink-0">$11,850</span>
                    </div>
                    <div class="ml-7 relative w-full bg-zinc-100 h-1.5 rounded-full overflow-hidden">
                        <div class="absolute inset-y-0 left-0 bg-indigo-500 rounded-full" style="width: 79%"></div>
                    </div>
                </div>

                <div>
                    <div class="flex items-center gap-3 mb-1.5">
                        <span class="text-xs font-semibold text-zinc-400 w-4 shrink-0 tabular-nums">3</span>
                        <span class="text-sm font-medium text-zinc-900 flex-1 truncate">Analytics Suite</span>
                        <span class="text-sm text-zinc-600 tabular-nums shrink-0">$9,640</span>
                    </div>
                    <div class="ml-7 relative w-full bg-zinc-100 h-1.5 rounded-full overflow-hidden">
                        <div class="absolute inset-y-0 left-0 bg-indigo-500 rounded-full" style="width: 64%"></div>
                    </div>
                </div>

                <div>
                    <div class="flex items-center gap-3 mb-1.5">
                        <span class="text-xs font-semibold text-zinc-400 w-4 shrink-0 tabular-nums">4</span>
                        <span class="text-sm font-medium text-zinc-900 flex-1 truncate">CRM Module</span>
                        <span class="text-sm text-zinc-600 tabular-nums shrink-0">$7,320</span>
                    </div>
                    <div class="ml-7 relative w-full bg-zinc-100 h-1.5 rounded-full overflow-hidden">
                        <div class="absolute inset-y-0 left-0 bg-indigo-500 rounded-full" style="width: 49%"></div>
                    </div>
                </div>

                <div>
                    <div class="flex items-center gap-3 mb-1.5">
                        <span class="text-xs font-semibold text-zinc-400 w-4 shrink-0 tabular-nums">5</span>
                        <span class="text-sm font-medium text-zinc-900 flex-1 truncate">API Access</span>
                        <span class="text-sm text-zinc-600 tabular-nums shrink-0">$5,310</span>
                    </div>
                    <div class="ml-7 relative w-full bg-zinc-100 h-1.5 rounded-full overflow-hidden">
                        <div class="absolute inset-y-0 left-0 bg-indigo-500 rounded-full" style="width: 35%"></div>
                    </div>
                </div>
